...
<div class="modal-body">  
	<form class="row" name="formSerie"> 
		<div class="form-group col-md-12 mb-md">
			...
			<input type="text" class="form-control input-sm" placeholder="Ingrese número de serie" ng-model="fData.numero_serie" 
				required tabindex="10" />
		</div>
		<div class="form-group col-md-12 mb-md">
			<label class="control-label mb-n"> Descripción: <small class="text-danger">(*)</small> </label> 
			<textarea class="form-control input-sm" placeholder="Descripción de Serie" ng-model="fData.descripcion_ser" 
				tabindex="20" required> </textarea> 
		</div>
	</form>
</div>

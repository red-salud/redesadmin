...
<div class="modal-body">  
	<form class="row" name="formClientePersona"> 
    	...
    	<div class="form-group col-md-3 mb-md">
			...
			<input type="text" class="form-control input-sm" ng-model="fData.ap_paterno" placeholder="Ingrese apellido paterno" required tabindex="45" />
		</div>
		<div class="form-group col-md-3 mb-md">
			<label class="control-label mb-n"> Ap. Materno: <small class="text-danger">(*)</small> </label>
			<input type="text" class="form-control input-sm" ng-model="fData.ap_materno" placeholder="Ingrese apellido materno" required tabindex="50" />
		</div>
		<div class="form-group col-md-3 mb-md">

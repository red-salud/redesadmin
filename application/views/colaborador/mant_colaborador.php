...
<div class="modal-body">  
	<form class="row" name="ColaboradorCtrl">
    	...
    	<div class="form-group col-md-3 mb-md">
			...
			<input type="text" class="form-control input-sm" ng-model="fData.ap_paterno" 
				placeholder="Ingrese apellido paterno" required tabindex="110" />
		</div>
		<div class="form-group col-md-3 mb-md">
			<label class="control-label mb-n"> Ap. Materno: <small class="text-danger">(*)</small> </label>
			<input type="text" class="form-control input-sm" ng-model="fData.ap_materno" 
				placeholder="Ingrese apellido materno" required tabindex="115" />
		</div>
		<div class="form-group col-md-3 mb-md">
		...
		<label class="control-label mb-n"> Usuario: </label>
			<div class="input-group">
			    <input type="text" class="form-control input-sm" ng-model="fData.username"  disabled="" 
			    	placeholder="Ingrese el usuario" tabindex="160"  />
			    <span class="input-group-btn">
			        <button tabindex="170" ng-click="btnNuevoUsuario();" type="button" class="btn btn-default btn-sm">

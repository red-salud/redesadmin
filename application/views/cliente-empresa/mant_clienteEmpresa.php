...
<div class="modal-body">  
	<form class="row" name="formClienteEmpresa"> 
		...
		<div class="form-group col-md-4 mb-md">
			...
			<input type="text" class="form-control input-sm" ng-model="fData.numero_documento" placeholder="Ingrese RUC" required tabindex="40" maxlength="40" />
		</div>
		<div class="form-group col-md-8 mb-md">
		...
		<div class="form-group col-md-6 mb-md">
			...
			<input type="text" class="form-control input-sm" ng-model="fData.pagina_web" placeholder="Ingrese página web" tabindex="100" />
		</div>
		<!-- <div class="form-group col-md-4 mb-md ">

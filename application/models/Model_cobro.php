...
class Model_cobro extends CI_Model {
	...
	public function m_cargar_cobros($paramPaginate, $paramDatos){ 
		...
		$this->db->select('cob.cob_id, cob_fechCob, cob_vezCob, cob_importe, cob_moneda, cob_iniCobertura, cob_finCobertura, 
			cert.cert_id, cert.cert_num, cert.cert_iniVig ,pl.idplan, pl.nombre_plan, pl.codigo_plan, 

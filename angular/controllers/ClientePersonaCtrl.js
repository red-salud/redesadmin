  ...
  $scope.btnBuscar = function(){
	...
	$scope.gridOptions = {
	    ...
	    columnDefs: [ 
	      ...
	      { field: 'nombres', name: 'nombres_cli', displayName: 'Nombres', minWidth: 140 },
	      { field: 'apellidos', name: 'apellidos_cli', displayName: 'Apellidos', minWidth: 140 },
	      { field: 'num_documento', name: 'numero_documento_cli', displayName: 'N° Documento', minWidth: 100 },
	      { field: 'edad', name: 'fecha_nacimiento_cli', displayName: 'Edad', minWidth: 90, enableFiltering: false },
	      { field: 'telefono_fijo', name: 'telefono_fijo_cli', displayName: 'Telefono Fijo', minWidth: 120 },
	      { field: 'telefono_movil', name: 'telefono_movil_cli', displayName: 'Teléfono Movil', minWidth: 120 },
	      { field: 'email', name: 'email_cli', displayName: 'Correo', minWidth: 180 },
	    ...
	    onRegisterApi: function(gridApi) { 
	      ...
	      $scope.gridApi.core.on.filterChanged( $scope, function(grid, searchColumns) {
	        ...
	        paginationOptions.searchColumn = {
	          ...
	          'cp.nombres_cli' : grid.columns[2].filters[0].term,
	          'cp.apellidos_cli' : grid.columns[3].filters[0].term,
	          'cp.numero_documento_cli' : grid.columns[4].filters[0].term,
	          'cp.telefono_fijo_cli' : grid.columns[6].filters[0].term,
	          'cp.telefono_movil_cli' : grid.columns[7].filters[0].term,
	          'cp.email_cli' : grid.columns[8].filters[0].term,
